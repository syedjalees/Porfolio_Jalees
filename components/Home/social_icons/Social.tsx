      ...
      <div className="flex flex-wrap justify-center gap-4 md:gap-6 lg:gap-8">
        {icons.map((social, idx) => (
          <a key={idx} href={social.link} target="_blank" className={`group no-underline text-center ${social.color}`}>
            ...
            <div className="relative w-[45px] h-[45px] sm:w-[50px] sm:h-[50px] md:w-[60px] md:h-[60px] mx-auto transition-transform duration-300 group-hover:-rotate-[35deg] group-hover:skew-x-[20deg]">
              {/* Layer 1 */}
              <span
